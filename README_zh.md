...
- [ 2025.06.12 ] 🏆 第二阶段（封闭评测）将于 **2026年6月16日 00:00（GMT+8）** 正式开启。第一阶段提交截止时间已延长至 **2026年6月15日 23:59（GMT+8）**。详情如下。
...
本次评测任务提交平台为 [Codabench](https://www.codabench.org/competitions/16946)。第二阶段（封闭评测，最终排名）将于 **2026年6月16日 00:00（GMT+8）** 正式开启。提交截止时间为 **2026年6月20日 23:59（GMT+8）**。每队最多可提交 **100 次**。提交期间无法查看分数；最终排行榜将于 **2026年6月22日** 前统一公布。
